          ...
          <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
              <a href="#" class="flex items-center">
                <img src={Location} class="h-8 me-3" alt="FlowBite Logo" />
            ...
            <div class="card flex space-x-4">
              ...
              >
                ...
                >
                  <path
                    fill-rule="evenodd"
                    d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.207 11.387.6.11.793-.258.793-.577 0-.285-.01-1.04-.015-2.04-3.333.723-4.042-1.582-4.042-1.582-.546-1.385-1.332-1.754-1.332-1.754-1.09-.743.083-.728.083-.728 1.205.085 1.838 1.238 1.838 1.238 1.07 1.834 2.807 1.305 3.495.997.108-.776.418-1.305.762-1.605-2.665-.307-5.467-1.332-5.467-5.93 0-1.31.468-2.38 1.237-3.222-.125-.307-.536-1.526.116-3.176 0 0 1.005-.322 3.3 1.23a11.49 11.49 0 0 1 3-.41c1.018.008 2.04.136 3 .41 2.29-1.552 3.294-1.23 3.294-1.23.654 1.65.242 2.87.117 3.176.77.842 1.236 1.91 1.236 3.222 0 4.61-2.807 5.62-5.482 5.92.43.372.818 1.102.818 2.22 0 1.602-.015 2.887-.015 3.277 0 .32.192.696.798.576C20.57 21.797 24 17.3 24 12c0-6.63-5.373-12-12-12z"
                  />
                </svg>
              </a>
