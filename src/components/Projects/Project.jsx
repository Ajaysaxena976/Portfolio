...
import chatapp from "../../assets/TextUtils.png"
...
const Projects = () => {
  return (
    <div className="bg-black-300 py-8">
      <h1 className="text-6xl text-center font-bold  text-purple-700">
        Major Projects
      </h1>
          ...
          <div className="mb-8 flex flex-wrap justify-center gap-8">
            ...
            <div className="w-full sm:w-1/2">
              <ProjectCard
                ...
                description="A React-based text utility app enhances readability and efficiency by offering features like uppercase/lowercase conversion, length calculation, and reading time estimation. It simplifies tasks, making it ideal for students, writers, and professionals alike."
                link="https://ajaysaxena976.github.io/textutils/"
                imageUrl={chatapp}
              />
            </div>
          </div>
